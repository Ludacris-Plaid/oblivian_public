...
class SpammerEngine:
    ...
    def _build_ai_prompt(self, target_profile: Dict,
        ...
        system_prompt = (
            "You are an elite email copywriter. You craft personalised, "
            "spam-filter-resistant marketing emails.\n\n"
            f"TONAL INSTRUCTION: {tone_instruction}\n\n"
            f"{recent_context}"
            "RULES:\n"
            "- NEVER hallucinate facts about the recipient's company.\n"
            "- Keep the email under 200 words.\n"
            "- Use the recipient's actual job_title and industry where provided.\n"
